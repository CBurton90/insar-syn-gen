function [] = fitVariogram(inputFile, wavelength,flg)
...
if flg == 1
    Data = load(inputFile); % load *.mat file
    insarData.Phase = Data(:,3);
    insarData.Lat = Data(:,2);
    insarData.Lon =  Data(:,1);
    insarData.Heading = Data(:,5);
    insarData.Inc = Data(:,4);
else
